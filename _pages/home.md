...
<div class="col-sm-4" style="display: table-cell; vertical-align: middle; text-align: right">
  ...
  <a href ="{{ site.url }}{{ site.baseurl }}/experience"> <img src="{{ site.url }}{{ site.baseurl }}/images/pages/adminZ.jpg" width="100%" alt="我自己" style="border-radius: 0; box-shadow: none; text-align: right"/></a>
